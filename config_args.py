...
def get_args(parser,eval=False):
    ...
    parser.add_argument('--dataset', type=str, choices=['coco', 'voc','coco1000','nus','vg','news','cub','hok4k','hok4kvis','hok4ktest'], default='coco')
    ...
    if args.dataset == 'voc':
        ...
        args.num_labels = 112
    elif args.dataset.startswith('hok4k'):
        args.num_labels = 2
    else:
