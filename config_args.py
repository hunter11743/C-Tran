...
def get_args(parser,eval=False):
    ...
    parser.add_argument('--dataset', type=str, choices=['coco', 'voc','coco1000','nus','vg','news','cub','hok4k','hok4kvis'], default='coco')
    ...
    if args.dataset == 'voc':
        ...
        args.num_labels = 112
    elif args.dataset == 'hok4k' or args.dataset == 'hok4kvis':
        args.num_labels = 2
    else:
